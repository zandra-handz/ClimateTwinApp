...
export const GlobalStylesProvider: React.FC<GlobalStylesProviderProps> = ({ children }) => {
  ...
  const [nonCustomHeaderPage, setNonCustomHeaderPage] = useState<boolean>(false);
  ...
  return (
    <GlobalStylesContext.Provider
      value={{ ...styles, themeStyles, themeStyleSpinners, nonCustomHeaderPage, setNonCustomHeaderPage }}
    >
      {children}
    </GlobalStylesContext.Provider>
  );
